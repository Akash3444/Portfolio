  ...
  return (
    <footer className="footer">
      <div className="footer__social">
        <div>
          <a href="mail:akashmoradiya3444@gmail.com">
            <i className="fa fa-envelope footer__icon" />
          </a>
        </div>
        <div>
          <a href="https://www.linkedin.com/in/akash-moradiya-6876671b7/">
            <i className="fa fa-linkedin footer__icon" />
          </a>
        </div>
        <div>
          <a href="https://github.com/Akash3444">
